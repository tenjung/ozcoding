        ...
        <Dialog>
            ...
            <DialogContent>
                ...
                <div className="flex flex-col gap-3">
                    <img src={props.urls.regular} alt="@IMAGE" className="w-full aspect-square object-cover rounded-md" />
                    <div className="w-full flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <img src={props.user.profile_image.large} alt="@PROFILE_IMAGE" className="w-7 h-7 rounded-full" />
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-start gap-2">
                            <TextInitial size={16} className="min-w-4 mt-1.5 text-neutral-500" />
                            <p className="text-neutral-500 line-clamp-3">{props.alt_description || "등록된 설명이 없습니다."}</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <Calendar size={16} className="text-neutral-500" />
                            <p className="text-neutral-500">{dayjs(props.created_at).format("YYYY. MM. DD")}</p>
                        </div>
                        <div className="flex items-center gap-2">
